...
The device is ready for use approximately 27 seconds after it is turned on. Up to 10 stages can be defined while programming the device. The device can reach the desired speed within an average of 5 seconds and keep it constant with an average of 6% margin of error. This error can go down to 2% at high speeds.
